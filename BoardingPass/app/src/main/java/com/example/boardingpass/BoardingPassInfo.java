...
/**
 * BoardingPassInfo is a simple POJO that simply acts as a placeholder for actual data,  contains information about, you guessed it, a boarding
 ...
 */
//Ideally this is filled with data from an airline API or some database lookup, but here we use fake data for simplicity
